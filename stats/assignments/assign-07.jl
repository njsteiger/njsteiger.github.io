...
using Statistics,StatsBase,HypothesisTests,StatsPlots,CSV
...
begin
	...
	filech = CSV.File(download(urlch))
end
...
👉 Just like you did in Exercise 2, use the boostrap approach to estimate the mean temperature of Europe based on the following temperature time series from 1880 to 2022. As above, use an `errorline` plot type to plot both your Switzerland and European ensemble temperature estimates together on the same figure."
