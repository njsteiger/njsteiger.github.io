...
md"_Note_: As we saw above with the simple math example, anytime that you modify a variable in one cell, its value will be automatically updated in other cells that use that same variable. So you need to be careful about how you name variables! If you want variables to be different, be sure to name them differently."
...
md"Above we saw that variables in Julia can take single values, but they can also represent vectors or matrices of data. For example, consider the variable **x** below: it's composed of five random numbers in a vector, generated by the function `rand`, which will generate any number of random numbers that you choose within the range 0 to 1."

# ╔═╡ 49e72a0d-ee59-4512-b3d3-2994b11c89a9
x=rand(5)

# ╔═╡ 3e8aef69-7c7f-4497-a8e1-a57e7cc27442
md"Just like variables can be vectors, they can also represent matrices of numbers or multiple letters together called 'strings' surrounded by parantheses. We'll mostly be using variables that are vectors and matrices."
...
md"If you want to select a value within a vector or matrix, you can do so using the following notation, just as you would refer to the location within a vector or matrix in linear algebra:"
...
md"If you want to refer to a range of data within a vector or matrix, you can do so like this:"
...
# ╔═╡ 0ba2c635-09e9-41fb-a23c-fc7ed4b350f1
...
# ╔═╡ bd0ee0b1-b428-4b84-85d4-5ff40c813446
...
# ╔═╡ e07ff1bb-b360-4ae4-8eaf-cc06f00e8817
begin
	d=rand(5)
	e=rand(5)
	f=d+e # only the result of this line will be printed
end

# ╔═╡ 2036e209-162a-4e57-92ff-110c94c331d5
md"In the above lines of code, I've inserted a comment following the character `#`. Julia, like any other programming language, will skip comments. They are only for us to help us understand what we've written."
...
Let's now look at some real data. Below is the URL for temperature data from London, UK, from 1948 to the beginning of 2023."
...
md"One way to fix this is to remove any values that are clearly only going to be representing missing values. Below I'm only selecting those values of the variable Tann that fall below 990. I'm using a dot before the < sign because that is how you tell Julia to do the comparison over every entry in the vector."
...
# ╔═╡ 569a191e-5f14-4304-9633-203d4ea8156f
...
# ╔═╡ e2cf9abc-1530-4da4-8933-00b1a4910dc8
